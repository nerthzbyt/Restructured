"""
Reglas del laboratorio src_dev — sin hardcode en tops ni umbrales.
...
5. Scoring derivado de métricas live + frecuencia de órdenes paginadas del exchange API.
6. output/ guarda ranking completo + debug de conexiones + errores.
"""
from __future__ import annotations

LAB_POLICY_VERSION = "1.1.0"

FORBIDDEN_IN_RANKING = (
